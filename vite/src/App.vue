        ...
        <section class="features" id="features">
          <div class="features-wrapper">
            <div class="section-header">
              ...
              <p>
                Voltooi elke missie, verdien badges en word helemaal klaar voor
                je 18e
              </p>
            </div>
        ...
        <section class="info-section">
          ...
          <div class="info-grid">
            ...
            <div class="info-card">
              ...
              <p>
                Alle informatie up‑to‑date en betrouwbaar, getoetst door
                experts.
              </p>
            </div>
            <div class="info-card">
...
const isVragen = computed(() => route.path === "/vragen");
